...
#just set up the benchmarks for HW
def TrieTest():
    trie1 = Trie()
...
print("BruteForce time= ", timeit.timeit(BruteForceTest, number=1))
print("KMP time= ", timeit.timeit(KMPTest, number=1))
print("Trie time= ", timeit.timeit(TrieTest, number=1))